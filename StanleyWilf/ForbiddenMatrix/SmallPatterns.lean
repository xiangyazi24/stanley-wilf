...
public import StanleyWilf.ForbiddenMatrix.ExtremalFunction
public import Mathlib.Data.Fin.VecNotation

import StanleyWilf.ForbiddenMatrix.MatrixOperations
...
/-- The diagonal `n × n` Boolean pattern. -/
...
/-- The two-row, three-column hat pattern used by the small-pattern extremal bounds. -/
